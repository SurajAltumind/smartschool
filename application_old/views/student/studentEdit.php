...
?> value="other"> <?php echo $this->lang->line('other'); ?>
                            ...
                            <div class="bozero">
                                ...
                                <h4 class="pagetitleh2">Subjects</h4>
                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                            ...
                                            <?php   $subject_result = $this->subject_model->get();
                                             $subject = $this->student_model->getStudentByid($sch_setting->id);
                                             $subject=explode(',',$subject[0]->subjects);
                                       //    echo '<pre>';print_r($subject);?>
                                            <?php foreach($subject_result as $sub){ ?>

                                           <div class="form-group col-md-3">

                                            <label class="radio-inline">

                                                <input type="checkbox" name="subjects[]" <?php echo in_array($sub['id'],$subject) ? "checked" : ""; ?> value="<?php echo $sub['id']?>">

                                            </label>
                                             <label><?php echo $sub['name'].' ('.$sub['type'].')'; ?></label>
                                              </div>
                                            <?php }?>
