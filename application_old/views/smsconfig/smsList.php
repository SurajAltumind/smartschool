            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom theme-shadow">
                    <ul class="nav nav-tabs pull-right">
                        ...
                        <li class="active"><a href="#tab_7" data-toggle="tab">Vilsa Sms</a></li>
                   <li ><a href="#tab_8" data-toggle="tab">SMS Atm</a></li>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane " id="tab_8">
                            ...
                            <form role="form" id="clickatell" action="<?php echo site_url('smsconfig/smsatm') ?>" class="form-horizontal" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 minheight170">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <?php
                                               // echo '<pre>';print_r($smslist);die;

                                                $vilsasms_result = check_in_array('smsatm', $smslist);
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-sm-5 control-label">SMS atm Username<small class="req"> *</small></label>

                                                    <div class="col-sm-7">

                                                        <input autofocus="" type="text" class="form-control" name="atmsms_sender" value="<?php echo $smsatm_result->username; ?>">

                                                        <span class=" text text-danger atmsms_user_error"></span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-sm-5 control-label">atmsms Password<small class="req"> *</small></label>

                                                    <div class="col-sm-7">

                                                        <input type="text" class="form-control" name="atmsms_api_id"  value="<?php echo $smsatm_result->api_id; ?>">

                                                        <span class=" text text-danger atmsms_api_id_error"></span>
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <label class="col-sm-5 control-label">atmsms From<small class="req"> *</small></label>

                                                    <div class="col-sm-7">

                                                        <input type="text" class="form-control" name="atmsms_from"  value="<?php echo $smsatm_result->from; ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                                        ...
                                                        <select class="form-control" name="atmsms_status">
                                                            ...
                                                            foreach ($statuslist as $s_key => $s_value) {
                                                                ...
                                                                <option 
                                                                    ...
                                                                    if ($smsatm_result->is_active == $s_key) {
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                ...
                                                <a href="https://www.smsatm.com/" target="_blank"><img src="https://smsatm.com/wp-content/uploads/2019/08/atmsmsr-600x158.png"><p>https://www.smsatm.com</p></a>
                        ...
                        <div class="tab-pane active" id="tab_7">
                            ...
                            <form role="form" id="clickatell" action="<?php echo site_url('smsconfig/vilsasms') ?>" class="form-horizontal" method="post">
                                        ...
                                        <div class="col-md-12 minheight170">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-sm-5 control-label">VIlsa Sender id<small class="req"> *</small></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-sm-5 control-label">atmsms Api key<small class="req"> *</small></label>
