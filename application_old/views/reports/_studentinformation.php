                        ...
                        <ul class="reportlists">
                        	<?php
                             ...
                             if ($this->rbac->hasPrivilege('student_report', 'can_view')) {
                                ...
                                <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/student_information/activestudentreport'); ?>"><a href="<?php echo base_url(); ?>student/activestudentreport"><i class="fa fa-file-text-o"></i> Active <?php echo $this->lang->line('student_report'); ?></a></li>
