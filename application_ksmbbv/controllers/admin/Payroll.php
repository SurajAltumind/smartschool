...
class Payroll extends Admin_Controller {
    ...
    function deductions($month, $year, $id) {
        ...
        $this->load->view("admin/payroll/deductions", $data);
    ...
    function deduct() {
       ...
       // print_r($_POST);die;
                ...
                $deduction_amount = $this->input->post("deduction_amount");
                 ...
                 $checkForUpdate = $this->payroll_model->delete_deductions($month, $year, $staff_id);
foreach($deduction_type as $k=> $deduct){
     $data = array('staff_id' => $staff_id,

             
                'detail' => $deduct,

                'total_deduction' => $deduction_amount[$k],
     ...
     $checkForUpdate = $this->payroll_model->save_deductions($data);
}
 redirect("admin/payroll");
    }
