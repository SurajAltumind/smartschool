    ...
    <section class="content">
        ...
        <?php } ?></td>
                                            ...
                                            ?>
                                                ...
                                                <td class="pull-right no-print">
                                                     <a class="btn btn-warning btn-xs checkbox-toggle edit_setting" role="button" href="<?php echo base_url() . "admin/payroll/deductions/" . $month_selected . "/" . $year . "/" . $staff["id"] ?>">Advance Payment</a>
