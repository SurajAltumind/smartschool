            ...
            //5235
                            ...
                            if ($this->rbac->hasPrivilege('student', 'can_edit')) {
                                ...
                                <li class="pull-right">
                                    ...
                                    <a class="btn btn-sm downloadDetails pull-right" href="<?=site_url("admin/generatecertificate/downloadReport") ?>/<?=$student["id"] ?>"  name="downloadD"  data-toggle="tooltip" data-placement="bottom" title="download report"><i class="fa fa-download"></i></a>
                                </li>
                                <?php
                            }
                        } else {
