...
class Payroll_model extends MY_Model {
    ...
    public function deletePayslip($payslipid) {
        ...
        public function delete_deductions($month, $year, $staff_id) {
        ...
        $this->db->where("staff_id", $staff_id);
         $this -> db -> delete('staff_deductions');
            ...
            public function getall_deductions($month, $year, $staff_id) {

        $this->db->where("month", $month);
        $this->db->where("year", $year);
        $this->db->where("staff_id", $staff_id);
       $query=  $this -> db -> get('staff_deductions');
          return $query->result_array();
    }
            public function save_deductions($data) {

       
        $this->db->insert('staff_deductions', $data);
    }
