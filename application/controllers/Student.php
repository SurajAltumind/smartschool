...
class Student extends Admin_Controller
{
    ...
    public function marksheetlog($id)
    {
        ...
        $data['title']         = 'Student Details';
        $marksheetLogs              = $this->student_model->getmarksheetdetails($id);
        $data["marksheetLogsDetails"] = $marksheetLogs;


        $this->load->view('layout/header', $data);
        $this->load->view('student/student_marksheet_log_report', $data);
        $this->load->view('layout/footer', $data);
    }
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($insert) {
                ...
                $user_password      = $this->role->$pass_id = '1001';//get_random_password($chars_min = 6, $chars_max = 6, $use_upper_case = false, $include_numbers = true, $include_special_chars = false);
                ...
                header("Location: https://ksmbbv.com/admin/generatecertificate/StudentAdmissionReport/$insert_id");
            } else {
