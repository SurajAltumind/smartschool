    ...
    public function subjectstudent()
    {
        ...
        if ($this->form_validation->run() == false) {
          ...
          $msg=array('lesson'=>$this->lang->line('not_authoried'));
            ...
            $data['section_id']                             = $this->input->post('section_id');
            $data['session_id']                             = $this->input->post('session_id');
            $data['markEntryType']                             = $this->input->post('markEntryType');
            $resultlist                                     = $this->examgroupstudent_model->examGroupSubjectResult($exam_subject_id, $class_id, $section_id, $session_id);
            $subject_detail = $this->batchsubject_model->getExamSubject($exam_subject_id);
            ...
            if (!empty($exam_group_student_id)) {
                foreach ($exam_group_student_id as $exam_group_student_key => $exam_group_student_value) {
                    ...
                    $array = array(
                        ...
                        'reading_marks'                          => $this->input->post('exam_group_student_reading_marks_' . $exam_group_student_value),
                        'writing_marks'                          => $this->input->post('exam_group_student_writing_marks_' . $exam_group_student_value),
                        'project_marks'                          => $this->input->post('exam_group_student_project_marks_' . $exam_group_student_value),
                        'sliptest_marks'                         => $this->input->post('exam_group_student_sliptest_marks_' . $exam_group_student_value),
                        'note'                                   => $this->input->post('exam_group_student_note_' . $exam_group_student_value),
                        'summative_exam_marks'                   => $this->input->post('exam_group_student_summative_exam_marks_' . $exam_group_student_value),
                        'faone_fatwo_marks'                      => $this->input->post('exam_group_student_faone_fatwo_marks_' . $exam_group_student_value),
                        'formative_exam_marks_status'            => $this->input->post('exam_group_student_formative_exam_marks_status_' . $exam_group_student_value),
                    );
                    $insert_array[] = $array;
            ...
            foreach ($rows as $row_key => $row_value) {
                ...
                if ($update_id == 0) {
                    ...
                    if ($this->input->post('exam_group_class_batch_exam_id') != ""
                        ...
                        && $this->input->post('exam_subject_type' . $row_value) != ""
                        ...
                        $insert_array[] = array(
                            ...
                            'exam_subject_type'               => $this->input->post('exam_subject_type' . $row_value),
