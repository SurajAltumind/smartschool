...
public function index() {
       ...
       $data['sch_setting']     = $this->setting_model->getSetting();
        ...
        $this->form_validation->set_rules('section_id', $this->lang->line('section'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('date', $this->lang->line('date'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('subject_timetable_id', $this->lang->line('subject'), 'trim|xss_clean');
        $this->form_validation->set_rules('attendanceType', $this->lang->line('attendanceType'), 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $attendanceFlag = $this->input->post('attendanceType');
            ...
            $resultlist = $this->studentsubjectattendence_model->searchAttendenceClassSection($class, $section, $subject_timetable_id, date('Y-m-d', $this->customlib->datetostrtotime($date)), $attendanceFlag);
            $data['resultlist'] = $resultlist;
