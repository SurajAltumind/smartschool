...
class Transaction extends Admin_Controller {
    ...
    function studentacademicreport() {
        ...
        $data['section_list']=$this->section_model->getClassBySection($this->input->post('class_id'));
         ...
         $student_Array = array();
                ...
                $classlist=$this->student_model->getAllClassSectionDueFees($class_from, $class_to);             
                ...
                $classlistdata[$value['class_id']][] = array(
    ...
    function studentacademicreportonlysum()
    {
        ...
        $this->load->view('layout/header', $data);
        $this->load->view('admin/transaction/studentAcademicReportSum', $data);
        $this->load->view('layout/footer', $data);
    }
