...
foreach($students as $student) 
{
    ...
    {
        $certificate_body=str_replace('[previous_class]',$student->class_id-1,$certificate[0]->certificate_text);
    }
    else if($student->class=="LKG")
    {
         $certificate_body=str_replace('[previous_class]','Prep',$certificate[0]->certificate_text);
    }
    else if($student->class=="UKG")
    {
        $certificate_body=str_replace('[previous_class]','LKG',$certificate[0]->certificate_text);
    }
    else if($student->class=="Class 1")
    {
        $certificate_body=str_replace('[previous_class]','UKG',$certificate[0]->certificate_text);
    }
    else if($student->class=="Senior BPC") 
    {
        $certificate_body=str_replace('[previous_class]','Junior BPC',$certificate[0]->certificate_text);
    }
    else if($student->class=="Junior CEC") 
    {
        $certificate_body=str_replace('[previous_class]','Senior CEC ',$certificate[0]->certificate_text);
    }
    else if($student->class=="Senior MPC") 
    {
        $certificate_body=str_replace('[previous_class]','Junior MPC',$certificate[0]->certificate_text);
    }
    else if($student->class=="Senior HEC") 
    {
        $certificate_body=str_replace('[previous_class]','Junior HEC ',$certificate[0]->certificate_text);
    }
    //----getting previous class 
