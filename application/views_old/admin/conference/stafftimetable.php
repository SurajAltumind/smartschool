                            ...
                            <table class="table table-hover table-striped table-bordered example">
                                <thead>
                                    <tr>
                                        ...
                                        <!-- custom code -->
                                        <th class="text-right"><?="Meeting Link"?></th>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    ...
                                                    if($conference_value->api_type != 'self') 
                                                    {
                                                        ...
                                                        if ($this->rbac->hasPrivilege('live_classes', 'can_delete')) {
                                                            ?>
                                                            <a style="margin-top:10px;margin-right:25px;" data-placement="left" href="<?php echo base_url(); ?>admin/conference/delete/<?php echo $conference_value->id . "/" . $return_response->id; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
