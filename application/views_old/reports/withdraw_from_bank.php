...
<div class="content-wrapper" style="min-height: 946px;">
                ...
                <div class="box removeboxmius">
                    <div class="box-header ptbnull"></div>
                      <div class="box-header with-border">
                       ...
                       // echo '<pre>';print_r($bank);die;
                       $totala=0;
                         foreach ($bank1 as  $valuea) {
                                                    if($valuea['type']==1){
                                                               $totala = $totala - $valuea['amount'];
                 
                                                    }elseif($valuea['type']==0){
                                                        $totala = $totala + $valuea['amount'];
 ...
 <?php   $banklists=        $this->session->userdata('bank');  ?>
                       <h4  class="  pull-right" style="padding-right: 10px;">Balance   <?php echo $banklists[2];  echo  ($currency_symbol . number_format($totalb, 2, '.', '')); ;?>        </h4>
                      <h4  class="  pull-right" style="padding-right: 10px;">Balance   <?php  echo $banklists[1]; echo  ($currency_symbol . number_format($totala, 2, '.', '')); ;?>        </h4>
                   
                    </div>

                     <form role="form" action="<?php echo site_url('report/withdraw_from_bank') ?>" method="post" class="">
                        <div class="box-body row">
                            ...
                            <div class="col-sm-6 col-md-12" >
                                <div class="form-group">
                                    ...
                                    <select name="bank" class="form-control" >
                                     <?php foreach($banklists as $k=>$bankl){?>
                                     <option value="<?php echo $k?>"><?php echo $bankl?></option>
                                     <?php }?>
                                    </select>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button type="submit" name="search" value="search_filter" class="btn btn-primary btn-sm checkbox-toggle pull-right">Withdraw</button>
                                </div>
                            </div>
                        </div>
                    </form>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                         ...
                                                         <td>
                                                            ...
                                                            <?php echo $banklists[$values['bank']]; ?>
