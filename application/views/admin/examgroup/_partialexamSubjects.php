        ...
        <table class="table table-bordered" id="item_table">
            <thead>
                <tr>
                    ...
                    <th class="">Subject Type </br>1-main subject,</br> 2-Co-curricular subjects</th>
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <input type="number" class="form-control item_unit tddm200" name="exam_subject_type<?php echo $count; ?>" value="<?php echo $exam_subject_value->exam_subject_type; ?>">
