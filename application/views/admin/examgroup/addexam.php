                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select id="markEntryType" name="markEntryType" class="form-control">
                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                    <option value="1">Formative Assisment</option>
                                    <option value="2">Summative Assessment</option>
                                </select>
                            </div>
                            <!--./form-group-->
                        </div>
...
<script>
    $(document).on('click', '.add', function() {
        ...
        html += '<td class="col-sm-1"><input type="number" name="exam_subject_type' + x + '" class="form-control" value="1"></td>';
