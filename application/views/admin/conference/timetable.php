                            ...
                            <table class="table table-hover table-striped table-bordered example">
                                <thead>
                                    <tr>
                                        ...
                                        <!-- custom code -->
                                        <th style="float:left"><?="Meeting Link"?></th>
                                        <!-- custom code -->
                                    </tr>
                                </thead>
                                <tbody>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    ...
                                                    if ($conference_value->status == 0) {
                                                        ...
                                                        <!-- <a data-placement="left" href="<?php echo $return_response->start_url; ?>" class="btn btn-default btn-xs"  target="_blank">
                                                            <i class="far fa-sign-in"></i> <?php echo $this->lang->line('start') . " " . $this->lang->line('class') ?>
                                                        </a> -->
                                                        <a style="" data-toggle="tooltip" data-original-title="Start Class"  data-placement="left" href="<?php echo $return_response->start_url; ?>" class="btn btn-default btn-xs"  target="_blank" >
                                                        <i class="fas fa-chevron-circle-right"></i> <?php echo $this->lang->line('start') . ' ' . $this->lang->line('class'); ?> 
                                                        </a>
                                                        <?php
                                                    }
                                                    ?>
                                                    ...
                                                    if ($conference_value->created_id == $logged_staff_id) {
                                                        if ($this->rbac->hasPrivilege('live_classes', 'can_delete')) {
                                                            ...
                                                            <a style="margin-top:8px;margin-right:25px;" data-placement="left" href="<?php echo base_url(); ?>admin/conference/delete/<?php echo $conference_value->id . "/" . $return_response->id; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
                                                 ...
                                                 <!-- custom code -->
                                                 <td class="mailbox-name">
                                                    <!-- zoom meeting invitation link with clipboard  -->
                                                    <!-- Target -->
                                                    <!-- <p id="foo-<?=$return_response->id?>"><?=$return_response->join_url?></p> -->
                                                    <input class="form-control" id="foo-<?=$return_response->id?>" value="<?=$return_response->join_url?>" >
                                                    <!-- Trigger -->
                                                </td>
                                                <td>
                                                    <a  data-toggle="tooltip" data-original-title="Copy" class="btn" data-clipboard-target="#foo-<?=$return_response->id?>">
...
<div class="modal fade" id="modal-classteacher-timetable">
    <div class="modal-dialog">
