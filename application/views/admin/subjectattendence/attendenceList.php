                                ...
                                <div class="col-md-4">
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select id="attendanceType" name="attendanceType" class="form-control">
                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            <option value="1">Manual Attendance</option>
                                            <option value="2">Automatic Attendance</option>
                                        </select>
                                        <span class="text-danger"><?php echo form_error('attendanceType'); ?></span>
                                    </div>
                                </div>
                              <div class="col-md-12">   
                                <div class="form-group">
