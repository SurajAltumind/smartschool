                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <form role="form" action="<?php echo site_url('admin/examresult/marksheet') ?>" method="post" class="row">
                            ...
                            <div class="col-sm-6 col-lg-4 col-md-4">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Attendance Start Date<small class="req"> *</small>
                                        <input type="date" class="form-control" name="startDate" value="<?php echo $startDate; ?>" style="width:100%">
                                        <span class="text-danger"><?php echo form_error('startDate'); ?></span>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-4 col-md-4">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Attendance End Date<small class="req"> *</small>
                                        <input type="date" class="form-control" name="endDate" value="<?php echo $endDate; ?>" style="width:100%">
                                        <span class="text-danger"><?php echo form_error('endDate'); ?></span>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    <input type="hidden" name="studentId" value="<?php echo $student_value->student_id; ?>">
                                                    <tr>
                                                      ...
                                                      <td><font color="red"><b><?php echo $student_value->published_date; ?></b></font></td>
