                                ...
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        ...
                                        if ($template->left_logo) {
                                            ?>
                                                <img src="<?php echo base_url('uploads/marksheet/' . $template->left_logo); ?>" style="width: 130px;height: 100px;">
                                            <?php
                                        }
                                        ?>
                                            ...
                                            if ($exam->exam_group_type != "gpa") {
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="top" style="text-align: left;border-right:1px solid #999">
                                                                       <center>
                                                                        <?php
                                                                      $totalper1=number_format((($total_obtain_marks * 100) / $total_max_marks), 2, '.', '');
                                                                       $totalper=round($totalper1);
                                                                      
                                                                        if ($totalper >= 91 and $totalper <= 100) {
                                                                            echo "A1";
                                                                      
                                                                        }
                                                                        if ($totalper >= 81 and $totalper <= 90) {
                                                                            echo "A2";
                                                                            
                                                                        }
                                                                        if ($totalper >= 71 and $totalper <= 80) {
                                                                            echo "B1";
                                                                          
                                                                        }
                                                                        if ($totalper >= 61 and $totalper <= 70) {
                                                                            echo "B2";
                                                                           
                                                                        }
                                                                        if ($totalper >= 51 and $totalper <= 60) {
                                                                            echo "C1";
                                                                         
                                                                        }
                                                                        if ($totalper >= 41 and $totalper <= 50) {
                                                                            echo "C2";
                                                                          
                                                                        }
                                                                        if ($totalper >= 35 and $totalper <= 40) {
                                                                            echo "D";
                                                                           
                                                                        }
                                                                        if ($totalper >= 0 and $totalper <= 34) {
                                                                            echo "E";
                                ...
                                <td valign="top">
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            ...
                                            if ($template->left_logo != "") {
                                                ?><img src="<?php echo base_url('uploads/marksheet/' . $template->left_logo); ?>" style="width: 130px;height: 100px;"> <?php } ?></td>
                                            <td valign="top">
                                                <table cellpadding="0" cellspacing="0" width="100%">
