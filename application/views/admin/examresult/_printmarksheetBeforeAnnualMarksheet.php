                        ...
                        <td valign="top">
                            <table cellpadding="0" cellspacing="0" width="100%" class="" style="    margin-top: 28px;">
                                ...
                                <tr>
                                    ...
                                    <td><b valign="top" style="font-size: 32px; font-weight: bold; text-align: center;text-transform: uppercase;"><?php echo $template->heading; ?></br></b><b>&nbsp;<b style="font-size: 18px;">Thallada, Khammam District, Telangana</b></br>Ph. : +91 8885943802  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Email: admin@ksmbbv.com</b></br><b style="font-size: 22px;"></br><?php echo $template->exam_name; ?> <?php echo $exam->session; ?></b></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b style="font-size: 22px;"> Marksheet</b></td>
                                </tr>
                            </table>
                                                ...
                                                ?>
                                                    ...
                                                    if ($studentClass == "Class 1" or $studentClass == "Class 2" or $studentClass == "Class 3" or $studentClass == "Class 4" or $studentClass == "Class 5") {
                                                        ...
                                                        ?>
                                                            ...
                                                            ?>
                                                            <th><?php echo $defaultGetMarks; ?></th>
                                                            <th>
                                                                <?php
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                ?>
                                                        ...
                                                        <td><?php  $calPerc=$totalSumGetMarks/140*100; 
