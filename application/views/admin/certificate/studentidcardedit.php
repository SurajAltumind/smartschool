                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        ...
                                        <input id="enable_roll_no" name="is_active_roll_no" type="checkbox" class="chk" <?php echo set_checkbox('is_active_student_img', '1', (set_value('is_active_roll_no', $editidcard[0]->enable_roll_no) == 1) ? TRUE : FALSE); ?> value="1">

                                        <label for="enable_roll_no" class="label-success"></label>
