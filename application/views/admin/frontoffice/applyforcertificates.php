<div class="content-wrapper" style="min-height: 348px;">
    ...
    <section class="content">
        <div class="row">
            <?php //if ($this->rbac->hasPrivilege('applyforcertificates', 'can_add')) { ?>
                <div class="col-md-4">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('apply'); ?> <?php echo $this->lang->line('for_certificates'); ?></h3>
                        </div><!-- /.box-header -->

                        <form id="form1" action="<?php echo site_url('admin/applyforcertificates') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" pattern="[789][0-9]{9}" id="contact" value="<?php echo set_value('contact'); ?>" name="contact">
                                    <span class="text-danger"><?php echo form_error('contact'); ?></span>
                                </div>

                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('date'); ?></label>
                                    <input id="date" name="date" placeholder="" id="date" type="text" class="form-control date" value="<?php echo set_value('date', date($this->customlib->getSchoolDateFormat())); ?>" readonly="readonly" />
                                    <span class="text-danger"><?php echo form_error('date'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="email"><?php echo $this->lang->line('reason'); ?></label>
                                    <textarea class="form-control" id="description" name="description" rows="3"><?php echo set_value('reason'); ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="note" name="note" name="note" rows="3"><?php echo set_value('admission_no'); ?></textarea>
                                    <span class="text-danger"><?php echo form_error('admission_no'); ?></span>
                                </div>

                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('approved_by'); ?>Approved By</label>
                                    <input type="text" class="form-control" value="<?php echo set_value('approved_by'); ?>" name="approved_by">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-danger"><?php echo form_error('certificate_type'); ?></span>
                                </div>
                ...
                <div class="col-md-<?php
                                    if ($this->rbac->hasPrivilege('applyforcertificates', 'can_add')) {
                                        echo "8";
                                    } else {
                                        echo "8";
                                    }
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="mailbox-date pull-right">
                                                        <a data-placement="left" onclick="getRecord(<?php echo $value['id']; ?>)" class="btn btn-default btn-xs" data-target="#calldetails" data-toggle="modal" title="<?php echo $this->lang->line('view'); ?>"><i class="fa fa-reorder"></i></a> <?php if ($this->rbac->hasPrivilege('applyforcertificates', 'can_edit')) { ?>
                                                            <a href="<?php echo base_url('admin/applyforcertificates/edit/' . $value['id']) ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                                                <i class="fa fa-pencil"></i>
                                                            </a>
                                                        <?php } ?>
                                                        <?php if ($this->rbac->hasPrivilege('applyforcertificates', 'can_delete')) { ?>
...
<script type="text/javascript">
    ...
    function printData() {
        ...
        frameDoc.document.write('<h4>' + document.getElementById("name").value + '</h4>');
        frameDoc.document.write('</body>');
        frameDoc.document.write('</html>');
