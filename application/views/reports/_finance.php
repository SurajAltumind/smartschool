                         ...
                         <?php
                             ...
                             if ($this->rbac->hasPrivilege('balance_fees_report', 'can_view')) {
                                ...
                                <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/studentacademicreport'); ?>"><a href="<?php echo base_url(); ?>admin/transaction/studentacademicreport"><i class="fa fa-file-text-o"></i>
                                  ...
                                  <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/studentacademicreportonlysum'); ?>"><a href="<?php echo base_url(); ?>admin/transaction/studentacademicreportonlysum"><i class="fa fa-file-text-o"></i>
                                Balance Fees Total Sum</a></li>
                    ...
                    <?php }
                     ...
                     <?php }
                        if($this->rbac->hasPrivilege('income_report','can_view')){ ?>
                         ...
                         <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/combinedincome'); ?>"><a href="<?php echo base_url(); ?>report/combinedincome"><i class="fa fa-file-text-o"></i> Combined <?php echo $this->lang->line('income')." ".$this->lang->line('report'); ?></a></li>
