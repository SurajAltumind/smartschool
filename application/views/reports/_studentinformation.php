                        ...
                        <ul class="reportlists">
                        	<?php
                        	 if ($this->rbac->hasPrivilege('student_report', 'can_view')) {
                                ...
                                <i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('student_report'); ?>
                                </a>
                                </li>
                            ...
                            {
                                ?>
                                <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/student_information/active_student_report'); ?>">
                                <a href="<?php echo base_url(); ?>student/activestudentReport">
                                <i class="fa fa-file-text-o"></i> Active <?php echo $this->lang->line('student_report'); ?>
                                </a>
                                </li>
                                <?php
                            }
                             if ($this->rbac->hasPrivilege('guardian_report', 'can_view')) {
                                ...
                                <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/student_information/guardian_report'); ?>">
                                <a href="<?php echo base_url(); ?>student/guardianreport"><i class="fa fa-file-text-o"></i>
