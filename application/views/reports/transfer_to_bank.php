...
<div class="content-wrapper" style="min-height: 946px;">
                ...
                <div class="box removeboxmius">
                    <div class="box-header ptbnull"></div>
                      <div class="box-header with-border">
                        <h3 class="box-title">Transfer to bank</h3>
 ...
 <?php   $banklists=        $this->session->userdata('bank'); ?>
                     ...
                     <form role="form" action="<?php echo site_url('report/transfer_to_bank') ?>" method="post" class="">
                        <div class="box-body row">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button type="submit" name="search" value="search_filter" class="btn btn-primary btn-sm checkbox-toggle pull-right">Transfer</button>
                                </div>
                            </div>
                        </div>
                    </form>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                         ...
                                                         <td>
                                                            ...
                                                            <?php echo $banklist[$values['bank']]; ?>
<?php echo $values['bank']; ?>
