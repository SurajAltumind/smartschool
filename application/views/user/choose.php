...
<div class="radio">
  <label>
      <?php $checked="checked";?>
    <input type="radio" <?php if($i==0){ echo $checked; } ?> value="<?php echo $student_value->student_session_id; ?>" class="clschg" name="clschg"><?php echo ($role == 'parent') ? $name . " " . $student_value->class . " (" . $student_value->section . ")" : $student_value->class . " (" . $student_value->section . ")"; ?>
  </label>
</div>
