...
<div class="receipt">
  ...
  <div class="orderNo">
    Employee ID# <span id="Order #">766610972</span>: <span id="Order Name"></span>
  </div>
  ...
  <div id="date">
   In Time: Saturday, Jun 13 2023 1:05:18
  </div>
  <svg id="barcode"></svg>
...
<div class="flex">
    ...
    <div class="totals">
      <div class="section">
        <div class="row">
          <div class="col1"></div>
          <div class="col2">Section 1</div>
          <div class="col3"></div>
        </div>
        <div class="row">
          <div class="col1"></div>
          <div class="col2">Section 2</div>
          <div class="col3"></div>
        </div>
        <div class="row">
          <div class="col1"></div>
          <div class="col2">Section 3</div>
          <div class="col3"></div>
        </div>
      </div>
      <div class="section">
 ...
 <div class="keepIt">
  ...
  <div class="keepItBody">
    This original receipt is required .
  </div>
</div>
