                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-md-4 col-md-offset-4">
                                <div class="alert <?php echo (isset($version) && $version != "") ? 'alert-danger':'alert-success' ?>">
                                    <p class="versionup">
                                        Your KSMBBV School Version <span> 6.1</span> </p>
                            ...
                            if (isset($version) && $version = "") {
                                ...
                                <div class="col-md-4 col-md-offset-4">
                                    <div class="alert alert-success">
                                        <p class="versionup"><?php echo $this->lang->line('latest')." ".$this->lang->line('app_name')." ".$this->lang->line('version'); ?> <br>Congratulations, Your software is activated for KSMBBV <span> <?php echo $version; ?></span></p>
                                    </div><!--./alert alert-danger-->
                                </div><!--./col-md-4 -->
