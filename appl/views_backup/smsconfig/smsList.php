                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 minheight170">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                $vilsasms_result = check_in_array('vilsasms', $smslist);
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                                        ...
                                                        <input autofocus="" type="text" class="form-control" name="vilsa_sender" value="<?php echo $vilsasms_result->username; ?>">

                                                        <span class=" text text-danger vilsa_user_error"></span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-sm-5 control-label">VIlsa Api key<small class="req"> *</small></label>

                                                    <div class="col-sm-7">

                                                        <input type="text" class="form-control" name="vilsa_api_id"  value="<?php echo $vilsasms_result->api_id; ?>">

                                                        <span class=" text text-danger vilsa_api_id_error"></span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                                        ...
                                                        <select class="form-control" name="vilsa_status">
                                                            ...
                                                            foreach ($statuslist as $s_key => $s_value) {
                                                                ...
                                                                <option 
                                                                    ...
                                                                    if ($vilsasms_result->is_active == $s_key) {
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                ...
                                                <a href="https://www.vilsasms.com/" target="_blank"><img src="https://vilsasms.com/wp-content/uploads/2019/08/vilsar-600x158.png"><p>https://www.vilsasms.com</p></a>
