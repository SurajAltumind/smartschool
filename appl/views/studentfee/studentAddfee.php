                                                    ...
                                                    <tr class="white-td">
                                                        ...
                                                        <td class="text text-right">
                                                            <div class="btn-group pull-right">
                                                                ...
                                                                <?php } ?>
                                                                <?php if($fee_deposits_value->accepted){?>
                                                                <a  href="/studentfee/updateFee/<?php echo $fee_value->id.'/'.$fee_value->fee_groups_feetype_id . "/" . $fee_deposits_value->inv_no; ?>"  >Received </a>
                                                                <?php }?>
