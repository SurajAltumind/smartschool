                        ...
                        <form action="<?php echo site_url('admin/certificate/edit/' . $editcertificate[0]->id) ?>"  id="certificateform" enctype="multipart/form-data" name="certificateform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="certificate_name" name="certificate_count" value="<?php echo set_value('certificate_count', $editcertificate[0]->certificate_count); ?>" type="number" class="form-control" />
                                ...
                                <div class="form-group">
                                    ...
                                    [current_date] [dob_in_words] [name] [dob] [Certi NO] [present_address] [guardian] [created_at] [admission_no] [roll_no] [class] [previous_class] [first_join_class] [from_year] [to_year] [section] [gender] [admission_date] [category] [cast] [father_name] [mother_name] [religion] [email] [phone][fee_total] [fee_paid] [fee_due] [fee_status]
 <?php
