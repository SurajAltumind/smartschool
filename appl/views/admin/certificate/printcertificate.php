...
{
    $certificate[0]->certificate_text=str_replace('[first_join_class]',$sd->class,$certificate[0]->certificate_text);
}
    ...
    foreach ($student as $std_key => $std_value) 
    {
       ...
       //--certificate number
        ...
        //----------session 
            ...
            $toyear1=(int)$fromyear-1; 
            $fromyear=(string)$fromyear;
            $toyear=(string)$toyear;
            $toyear1=(string)$toyear1;
                ...
                $certificate_body=str_replace('[from_year]', $toyear1.'-'.$fromyear, $certificate_body);
                $certificate_body=str_replace('[to_year]', $fromyear.'-'.$toyear, $certificate_body);
        //-----------session 
