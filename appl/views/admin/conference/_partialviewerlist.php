            ...
            <tbody>
                ...
                foreach ($viewerDetail as $viewer_key => $viewer_value) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $viewer_value->firstname . " " . $viewer_value->lastname; ?></td>
                        ...
                        <!-- --------------customization----------------------- -->
                        <td><?php echo $this->customlib->dateyyyymmddToDateTimeformat($viewer_value->login_time); ?></td>
                        <td ><?php echo $this->customlib->dateyyyymmddToDateTimeformat($viewer_value->logout_time); ?></td>
                        <!-- --------------customization----------------------- -->
                    </tr>
                    <?php
                }
