...
class Question extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->session->set_userdata('sub_menu', 'Online_Examinations/question');
        // custom code start
        $class_id   = $this->input->post("class_id_filter");
        $section_id = $this->input->post("section_id_filter");
        $subject_id_filter=$this->input->post("subject_id_filter");
        $data['class_id']    = $this->input->post('class_id_filter');
        $data['section_id']  = $this->input->post('section_id_filter');
        $data['subject_id_filter']  = $this->input->post('subject_id_filter');
    ...
    public function getQuestionByFilter()
    {
        ///ajax request
        $class_id=$this->input->post("class_id");
        $section_id=$this->input->post("section_id");
        $subject_id_filter=$this->input->post("subject_id");
        $data=$this->question_model->getQuestionFilter($class_id,$section_id,$subject_id_filter);
