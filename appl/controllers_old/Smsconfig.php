...
class Smsconfig extends Admin_Controller {
    ...
    public function vilsasms() {



        $this->form_validation->set_error_delimiters('', '');

        $this->form_validation->set_rules('vilsa_sender', $this->lang->line('username'), 'required');

        $this->form_validation->set_rules('vilsa_api_id', $this->lang->line('api_id'), 'required');
        ...
        if ($this->form_validation->run()) {
            ...
            $data = array(
                ...
                'username' => $this->input->post('vilsa_sender'),

                'api_id' => $this->input->post('vilsa_api_id'),

                'is_active' => $this->input->post('vilsa_status'),
            ...
            $data = array(
                ...
                'vilsa_api_id' => form_error('vilsa_api_id')
        ...
        public function smsatm() {



        $this->form_validation->set_error_delimiters('', '');

        $this->form_validation->set_rules('atmsms_sender', $this->lang->line('username'), 'required');

        $this->form_validation->set_rules('atmsms_api_id', $this->lang->line('api_id'), 'required');
        ...
        if ($this->form_validation->run()) {
            ...
            $data = array(
                ...
                'username' => $this->input->post('atmsms_sender'),

                'api_id' => $this->input->post('atmsms_api_id'),
                  'from' => $this->input->post('atmsms_from'),

                'is_active' => $this->input->post('atmsms_status'),
       ...
       //     echo '<pre>';print_r($data);die;
            ...
            $data = array(
                ...
                'atm_api_id' => form_error('atm_api_id')
