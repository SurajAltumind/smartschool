...
class Question extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        // {
        //   $questionList         = $this->question_model->getByClassSection($class_id,$section_id);
        ...
        $data['questionList'] = $questionList;
        // custom code start
        // $class_result       = $this->classsection_model->getByID();
    ...
    public function getQuetionByClassSection()
    {
      if (!$this->rbac->hasPrivilege('question_bank', 'can_view')) 
      {
        access_denied();
      ...
      // $questionList         = $this->chkClassSectionRecord->get();
      // $data['questionList'] = $questionList;
    ...
    public function add()
    {
        ...
        //custom code start
        $this->form_validation->set_rules('class_id', $this->lang->line('class'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('section_id1', $this->lang->line('section'), 'trim|required|xss_clean');
        // custom code end
        ...
        if ($this->form_validation->run() == false) {
            ...
            $msg = array(
                ...
                'section_id'   => form_error('section_id1'),
                // custom code end
