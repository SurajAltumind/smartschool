...
?>
                    ...
                    <div class="col-md-3 col-sm-6" style="width: 20%;">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="search_class" id="search_class" style="display: inline-block;">
                                <option value=""><?php echo $this->lang->line('select') ?></option>
                                <?php
                                        //foreach ($subjectlist as $subject_key => $subject_value) {
                                ...
                                <option value="<?php echo $class_value->class ?>"><?php echo $class_value->class ?></option>
                     ...
                     <div class="col-md-3 col-sm-6"  style="width: 20%;">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="search_sub" id="search_sub" style="display: inline-block;">
                                <option value=""><?php echo $this->lang->line('select') ?></option>
                                    <?php
                                        //foreach ($subjectlist as $subject_key => $subject_value) {
                                            foreach ($sectionlist as $section_value) {
                                    ?>
                                <option value="<?php echo $section_value['section'] ?>"><?php echo $section_value['section']     ?></option>
                     ...
                     <div class="col-md-2 col-sm-6">
                        <label style="display: block; visibility:hidden;">Filter</label>
                        <button type="button" class="btn btn-info btn-sm post_search_submit_filter">Filter<?php //echo $this->lang->line('filter'); ?></button>
                    </div>
<!-- ********************************************************************************************* -->
...
<script type="text/javascript">
   ...
   $('#myQuestionModal').on('hidden.bs.modal', function () {
    ...
    //custom code
    $(document).on('click', '.post_search_submit_filter', function (e){

        var class_filter = $('#search_class').val();
        var sub_filter = $('#search_sub').val();
        class_filter = class_filter.replace(/\s/g, '');
        sub_filter = sub_filter.replace(/\s/g, '');
        //$(".rltpaddleft").parent().css('display', 'none');
        $(".display").hide();
        console.log(class_filter+sub_filter);

        if(class_filter !== null){
            console.log('inside if'+ class_filter)
            $("."+class_filter).parent().parent().parent().parent().parent().show();
        }
        if(sub_filter !== null){
            console.log('inside if'+ sub_filter)
            $("."+sub_filter).parent().parent().parent().parent().parent().show();
        }
