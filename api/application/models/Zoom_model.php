...
class Zoom_model extends CI_Model 
{
   public function __construct() 
   {
	...
	//start  model for saving auto zoom attendance record //
    public function SaveAutoZoomAttendanceRecord($AutoAttendancedetails)
    {
        $this->db->trans_start();
        $this->db->trans_strict(false);
        $this->db->insert('student_automatic_attendance', $AutoAttendancedetails);
        $this->db->trans_complete();
	...
	// ----------End Model for saving zoom attendance record details//
